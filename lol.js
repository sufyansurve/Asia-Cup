/*!
   JW Player version 8.28.0
   Copyright (c) 2023, JW Player, All Rights Reserved
   This source code and its use and distribution is subject to the terms
   and conditions of the applicable license agreement.
   https://www.jwplayer.com/tos/
   This product includes portions of other software. For the full text of licenses, see
   https://ssl.p.jwpcdn.com/player/v/8.28.0/notice.txt
*/
(() => {
    var e, t, n = {
            696: (e, t, n) => {
                ...
                const r = {
                    ...
                    hd: "Quality",
                    liveBroadcast: "Join TG @iamsom77",
                    logo: "Logo",
                    mute: "Mute",
                    next: "Next",
                    nextUp: "Next Up",
            ...
            5083: (e, t, n) => {
                ...
                const u = {
                    ...
                    p = function(e, t) {
                        ...
                        let C = y.liveTimeout;
                        null !== C && ((0, s.qh)(C) ? 0 !== C && (C = Math.max(30, C)) : C = null, y.liveTimeout = C);
                        const j = parseFloat(y.bandwidthEstimate),
                            P = parseFloat(y.bitrateSelection);
                        return y.bandwidthEstimate = (0, s.qh)(j) ? j : function(e) {
            ...
            623: (e, t, n) => {
                ...
                const T = function(e) {
                    ...
                    Z = e => A(e) ? Promise.resolve() : P(e).then((() => {
                        if (e.get("drm") || (0, x.w0)(e.get("playlist"))) return (0, x.lD)(e.get("edition"))
                    })).then((() => {
                        return P(t = e).then((() => {
                            if (S(t)) return;
                                    ...
                                    case "subtitle":
                                        {
                                            ...
                                            (0, i.Dc)(c, "lang").length > 0 && (e.label = s((0, i.Dc)(c, "lang"))),
                                            n.push(e);
                                            break
                                        }
                                }
            ...
            8518: (e, t, n) => {
                ...
                const S = (e, t, n, r) => {
                    ...
                    x = (e, t) => {
                        ...
                        return S(n, "errors", e, t), S(n, "related", e, t), S(n, "sharing", e, t), S(n, "advertising", e, t), S(n, "shortcuts", e, t), S(n, "captionsStyles", e, t), n
                    }
            },
            5499: (e, t, n) => {
                "use strict";
            ...
            1569: (e, t, n) => {
                ...
                const o = function(e) {
                    ...
                    s = function() {
                        const e = "//ssl.p.jwpcdn.com/player/v/8.28.0";
            ...
            5882: (e, t, n) => {
                ...
                const b = (e, t, n) => {
                    ...
                    x = (e, t) => {
                        if (v || (v = new F(document).on("interaction")), e.handlers[p] || e.handlers[h]) return;
                        const {
                            el: n
                        } = e;
                        C(e, t, "blur", (() => {
                    ...
                    E = e => {
                        ...
                        x(e, h), O(e, h, (n => {
                            ...
                            S(n) || Boolean(e.directSelect) && r !== t || (n.isPrimary && "BUTTON" === r.tagName && r.focus(), e.lastStart = (0, s.z)(), e.clicking = !0)
                        })), C(e, h, "click", (n => {
                            S(n) || Boolean(e.directSelect) && n.target !== t || ((0, s.z)() - e.lastStart > 500 && !0 === e.clicking || (((e, t) => {
                    ...
                    A = e => {
                        ...
                        const {
                            ...
                            clearTimeout(y), e.el && (j(e), P(e, d), e.dragged && (e.dragged = !1, b(e, i.Sv, t)))
                        };
                        x(e, p), O(e, p, (i => {
            ...
            4671: (e, t, n) => {
                ...
                document.addEventListener("visibilitychange", d), document.addEventListener("webkitvisibilitychange", d), window.addEventListener("beforeunload", (() => {
                    document.removeEventListener("visibilitychange", d), document.removeEventListener("webkitvisibilitychange", d), window.removeEventListener("scroll", h)
                }));
                const f = {
                    add(e) {
                        i.push(e)
                ...
                const g = e => "string" == typeof e && /^\/\/(?:content\.jwplatform|cdn\.jwplayer)\.com\//.test(e),
                    ...
                    v = e => {
                        const t = "file:" === window.location.protocol ? "https:" : "",
                            n = {
                                bidding: "//ssl.p.jwpcdn.com/player/v/8.28.0/bidding.js",
                                jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.28.0/jwpsrv.js",
                                dai: "//ssl.p.jwpcdn.com/player/v/8.28.0/dai.js",
                                vast: "//ssl.p.jwpcdn.com/player/v/8.28.0/vast.js",
                                googima: "//ssl.p.jwpcdn.com/player/v/8.28.0/googima.js",
                                freewheel: "//ssl.p.jwpcdn.com/player/v/8.28.0/freewheel.js",
                                gapro: "//ssl.p.jwpcdn.com/player/v/8.28.0/gapro.js",
                                interactive: "//ssl.p.jwpcdn.com/player/v/8.28.0/interactive.js"
                            }[e];
                        return n ? t + n : ""
                    },
                    b = (e, t, n) => {
            ...
            576: (e, t, n) => {
                ...
                function P(e) {
                    ...
                    r.tick("init"), e.setAttribute("data-jwplayer-id", n), Object.defineProperties(this, {
                        ...
                        _events: {},
                        setup(t) {
                            return r.clear("ready"), r.tick("setup"), o && j(this, o), o = C(this, e), o.init(t, this), this.on(t.events, null, this)
                        },
                        remove() {
                            return this.getPip() && this.setPip(!1),
                                ...
                                }(this), o && j(this, o), Object.keys(i).forEach((e => {
                                    delete i[e]
                                })), this
                        },
                        qoe() {
                ...
                const S = e => {
                    ...
                    x = function(e) {
                        let t, n;
                        if (e ? "string" == typeof e ? (t = S(e), t || (n = document.getElementById(e))) : "number" == typeof e ? t = s.Z[e] : e.nodeType && (n = e, t = S(n.id || n.getAttribute("data-jwplayer-id"))) : t = s.Z[0], t) return t;
                        if (n) {
                            const e = new P(n);
                            return s.Z.push(e), e
                        }
                ...
                Object.assign(W, L), O(W), "function" == typeof G.define && G.define.amd && G.define([], (function() {
                    return W
                }));
                let K = W;
...
var jwDefaults = {
    ...
    "displaytitle": true,
    "height": 360,
    "key": "qAzKT4kdiw43bLe3l3js0W2b3jXxhAQRCfhSOvImnAWZcnJ9tVfwBuKsUTHtsSy1",
    "mute": false,
    "ph": 1,
    "pid": "KB5zFt7A",
